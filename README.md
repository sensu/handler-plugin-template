...
## Overview
handler-plugin-template is a template repository which wraps the [Sensu Plugins Go Library][2].
...
The {{ .Name }} is a [Sensu Handler][9] that ...
...
[10]: https://docs.sensu.io/sensu-go/latest/reference/handlers/